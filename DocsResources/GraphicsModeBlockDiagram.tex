...
\tikzstyle{Blk6}=[draw, fill=green!20, text width=8em,
text centered, minimum height=8em, minimum width=10em]

\tikzstyle{memBlk}=[draw, fill=yellow!20, text width=5em,
text centered, minimum height=12em, minimum width=12em, rounded corners]
...
\begin{tikzpicture}
    ...
    \node[Blk4] at ([xshift=23em]pixelLocationGeneratorBlock) (arb) {Address \&  RGB Generator};
