...
text centered, minimum height=8em, minimum width=10em]

\tikzstyle{Blk5}=[draw, fill=magenta!20, text width=7em,
text centered, minimum height=8em, minimum width=8em]

\tikzstyle{Blk6}=[draw, fill=green!20, text width=2em,
text centered, minimum height=10em, minimum width=2em]
...
\begin{tikzpicture}
    ...
    \node[Blk4] at ([xshift=23em]pixelLocationGeneratorBlock) (arb) {TextMode Index Generator};
    ...
    \node[Blk5] at ([yshift=0em, xshift=22em]arb) (TB) {TextMode Text Buffer};

    \node at ([xshift=0em, yshift=-10em]TB) (bramMem) [memBlk] {TextMode Character ROM};
    ...
    \draw[->, line width=1.5pt] (hsyckBlock.east) -- ([xshift=60em]hsyckBlock.east) node[right,pos=1] {hSYNC};
    \draw[->, line width=1.5pt] (vsyckBlock.east) -- ([xshift=60em]vsyckBlock.east) node[right,pos=1] {vSYNC};



    \draw[->, line width=1.5pt] ([yshift=0em]arb.east) -- ([xshift=0em]TB.west) node[yshift=0em,above, xshift=-6.8em] {currentCharacterPixelIndex};
    \draw[->, line width=1.5pt] ([yshift=0em]TB.south) -- ([xshift=0em]bramMem.north) node[yshift=2em,left, xshift=0em] {currentCharacterIndex};



    \node[Blk6] at ([xshift=13em]TB) (gggg) {};

    \draw[->, line width=1.5pt] ([yshift=0em]bramMem.east) -| ([xshift=0em]gggg.south) node[yshift=0em,below, pos=0.5, xshift=0em] {currentCharacter};
    \draw[->, line width=1.5pt] ([yshift=0em]TB.east) -- ([xshift=0em]gggg.west) node[yshift=0em,below, pos=0.5, xshift=0em] {characterXY};


    \draw[->, line width=1.5pt] ([yshift=1.5em]gggg.east) -- ([yshift=1.5em, xshift=6em]gggg.east) node[right,pos=1] {R};
    \draw[->, line width=1.5pt] ([yshift=0em]gggg.east) -- ([yshift=0em, xshift=6em]gggg.east) node[right,pos=1] {G};
    \draw[->, line width=1.5pt] ([yshift=-1.5em]gggg.east) -- ([yshift=-1.5em, xshift=6em]gggg.east) node[right,pos=1] {B};
